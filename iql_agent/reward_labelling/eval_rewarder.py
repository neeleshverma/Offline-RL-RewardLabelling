...
from iql_agent.reward_labelling import ot_rewarder as ot_rewarder


class OptimalTransportRewarderTest(absltest.TestCase):
  ...
  def test_rewarder(self):
    ...
    rewarder = ot_rewarder.OptimalTransportRewarder(expert_demos, episode_length)
  ...
  def test_zero_rewards_for_expert_demo(self):
    ...
    rewarder = ot_rewarder.OptimalTransportRewarder(
        ...
        squashing_fn=functools.partial(
            ot_rewarder.squashing_linear, alpha=1.))
